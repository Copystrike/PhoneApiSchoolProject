...
{
    public class InMemoryAppsService : IAppsService
    {
        private IMapper _mapper;

        private static List<AppsModel> Apps;

        public InMemoryAppsService(IMapper mapper)
        {
            _mapper = mapper;
            Apps = new List<AppsModel>
            {
                new(Guid.Parse("cd8fd36a-b3f8-414d-bb7e-b7e2ff28ca47"), "Slack", "v1.0", "Slack Technologies",
                    "Business",
                ...
                new(Guid.Parse("41f75c18-c009-4db7-a0d8-95c89a29e646"), "Microsoft Teams", "v1.0", "Microsoft",
                    "Business",
                ...
                new(Guid.Parse("0eae0368-af5f-4f62-86da-bf2fa1657981"), "Discord", "v1.0", "Discord Inc.",
                    "Social Media",
                    0, new DateTime(2015, 5, 13), Guid.Parse("cd8fd36a-b3f8-414d-bb7e-b7e2ff28ca47")),
                new(Guid.Parse("596e0c09-4567-46fe-9f97-fb919197f2dc"), "Minecraft", "v1.0", "Mojang Studios", "Games",
                    10,
                ...
                new(Guid.Parse("86009346-bdb9-4ee8-a166-9a6b3a399ac4"), "Cyberpunk 2077", "v1.0", "CD Projekt", "Games",
                    60,
        ...
        {
            var existingApp = Apps.FirstOrDefault(existingApp => existingApp.Id == app.Id);
        ...
        {
            return Apps.Where(app => app.Id == osId).ToList();
        }
    }
}